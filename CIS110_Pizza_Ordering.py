print("Hello, my name is Kora your vitual assistant. I will help you order a pizza!")
...
if userName.lower() == "cortez":
    print(f"\nMy creator, {userName}. what's up dude let's order some magic!")
else:
...
while keepGoing.lower() == "y":
    ...
    method = input("\nIs this order carry out or delivery?:  ")
    while method not in ["carry out", "delivery"]:
        method = input("Invalid Value!  Please enter carry out of delivery:  ")
    ...
    while keepGoing.lower() not in ["y", "n"]:
        keepGoing = input("Invalid Value: Enter y or no: ")